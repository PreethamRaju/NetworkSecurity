...
The Plain text is converted to binary by first calculating the ascii values and then converting it to binary.
In the end, after decrypting the cipher text, the binary is converted to text with the use of encoding standard "utf-8".
