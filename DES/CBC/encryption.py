...
def encrypt(li,ri,key):
	expand = exp(ri)
	print 'Output of expansion function'	
	print expand
	'print k1'
	...
	print 'Output of exor operation with key'
	print exor
	'print a'
	'print b'
	...
	'print s7'
	'print s8'
	print 'Output of Sbox function'
	print (s1+s2+s3+s4+s5+s6+s7+s8)

	permin = permf(s1+s2+s3+s4+s5+s6+s7+s8)
	print 'Output of permutation function'
	print permin
...
print 'Random generated input key(64 bit)'
print keybin
