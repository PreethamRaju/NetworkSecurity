...
keybin = '1001000100010010001101110100101101111000101000011010101001100111'
iv = '0000000001010111110111100001011110110011001100100111011110101101'
...
for y in range (1,217):
	...
	ctext = invip(swapout)
	print ctext
	ct = (bin(int(iv,2)^int(ctext,2)))[2:].zfill(64)
	iv = pt
	...
	cipher = (c1+c2+c3+c4+c5+c6+c7+c8)
	print cipher
	txtout.write(cipher)
	print (8*y+z)
txt.close()
